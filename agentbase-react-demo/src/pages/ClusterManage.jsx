...
const data = [
  { name: 'agent1-az1', desc: 'agent1-az1可用区集群', status: '✅ 已连接', address: 'https://10.103.xxx.xxx:6443', blockSC: 'csi-disk', objectSC: 'csi-obs', testTime: '2025-03-28 15:30', addTime: '2025-03-25 10:00' },
  { name: 'agent2-az1', desc: 'agent2-az1可用区集群', status: '✅ 已连接', address: 'https://10.103.xxx.xxx:6443', blockSC: 'csi-disk', objectSC: 'csi-obs', testTime: '2025-03-28 15:30', addTime: '2025-03-25 10:00' },
]
