...
const INITIAL_ENVIRONMENTS = [
  {
    ...
    createdAt: ts(14),
    sessionsCount: 12,
    description: '企业级大模型推理与深度数据洞察环境，支持高并发分析任务',
  },
  {
    id: 'env-002',
    name: '网页与接口连接中心',
    ...
    createdAt: ts(7),
    sessionsCount: 5,
    description: '跨平台流程自动化与三方服务集成枢纽，支持快速 API 调用与网页抓取',
  },
  {
    id: 'env-003',
    name: '系统审计与扫描引擎',
    ...
    createdAt: ts(10),
    sessionsCount: 2,
    description: '高性能合规性审计与漏洞扫描沙箱，专为系统级任务设计',
  },
]
...
const INITIAL_AUDIT_LOGS = [
  ...
  { id: 'aud-008', userId: 'admin', userName: 'Admin', action: 'environment.update', resourceType: 'Environment', resourceId: 'env-001', resourceName: 'AI 智能分析集群', result: 'success', ipAddress: '10.0.1.100', timestamp: ts(3), metadata: {} },
]
